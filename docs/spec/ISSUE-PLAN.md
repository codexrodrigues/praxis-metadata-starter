...
Milestones
1) Levantamento do contrato (starter + runtime Angular público)
...
- O host Angular baseado nos pacotes públicos `@praxisui/*` renderiza tabela/form sem mudanças além de `baseUrl`.

Referências
- docs/spec/ (este diretório)
- praxis-metadata-starter/src/main/javadoc/doc-files/faq.html
- https://github.com/codexrodrigues/praxis-ui-angular

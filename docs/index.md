...
- `/{resource}/capabilities` tambem publica `stats.fields` quando o service declara `StatsFieldRegistry`, permitindo que runtimes escolham dimensoes e metricas de charts antes de executar stats

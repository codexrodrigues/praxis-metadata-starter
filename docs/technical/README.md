...
Esta area concentra apenas referencia tecnica ainda viva do
`praxis-metadata-starter`. Ela nao e onboarding principal.
...
- Javadoc publicado: [GitHub Pages](https://codexrodrigues.github.io/praxis-metadata-starter/apidocs/)

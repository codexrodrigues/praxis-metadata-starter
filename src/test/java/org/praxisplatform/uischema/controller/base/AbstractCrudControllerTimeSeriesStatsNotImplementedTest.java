...
@WebMvcTest(AbstractCrudControllerTimeSeriesStatsNotImplementedTest.SimpleController.class)
@Import(AbstractCrudControllerTimeSeriesStatsNotImplementedTest.SimpleController.class)
class AbstractCrudControllerTimeSeriesStatsNotImplementedTest {
    ...
    @Test
    void returns501WhenTimeSeriesStatsAreNotImplemented() throws Exception {

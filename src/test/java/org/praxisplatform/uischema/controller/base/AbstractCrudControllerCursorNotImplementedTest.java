...
@WebMvcTest(AbstractCrudControllerCursorNotImplementedTest.SimpleController.class)
@Import(AbstractCrudControllerCursorNotImplementedTest.SimpleController.class)
class AbstractCrudControllerCursorNotImplementedTest {
    ...
    void returns501WhenNotImplemented() throws Exception {
        mockMvc.perform(post("/simple/filter/cursor")

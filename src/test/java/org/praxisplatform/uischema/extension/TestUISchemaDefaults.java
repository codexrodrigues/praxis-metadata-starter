 ...
 * Uses the same defaults as UISchema annotation (controlType=AUTO etc.).
 */
public final class TestUISchemaDefaults {
    private static final UISchema DEFAULT = new UISchema() {
        ...
        @Override public IconPosition iconPosition() { return IconPosition.LEFT; }
        ...
        @Override public ValidationPattern pattern() { return ValidationPattern.CUSTOM; }
        ...
        @Override public AllowedFileTypes allowedFileTypes() { return AllowedFileTypes.ALL; }

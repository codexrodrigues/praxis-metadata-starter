...
class JdbcBulkProposalStorePostgresTest {
    ...
    @Test void concurrentMigrationHasOneVersionApplication() throws Exception {
        ...
        try (var executor = Executors.newFixedThreadPool(2)) {
            ...
            assertThat(first.get(30, TimeUnit.SECONDS)+second.get(30, TimeUnit.SECONDS)).isEqualTo(4);
        }
        BulkExecutionMigrator.validate(dataSource);
    }
    ...
    @Test void detectsChangedCheckSemanticsUnloggedTableAndDeferredPrimaryKey() {
        String[] mutations = {
            ...
            "alter table praxis_bulk.praxis_bulk_item_receipt set unlogged; alter table praxis_bulk.praxis_bulk_admission set unlogged; alter table praxis_bulk.praxis_bulk_execution set unlogged; alter table praxis_bulk.praxis_bulk_evaluation set unlogged; alter table praxis_bulk.praxis_bulk_proposal set unlogged",

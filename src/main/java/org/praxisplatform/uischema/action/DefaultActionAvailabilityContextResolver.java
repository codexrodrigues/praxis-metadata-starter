...
/**
 * Resolve o contexto baseline de availability de actions a partir do request atual.
 */
public class DefaultActionAvailabilityContextResolver implements ActionAvailabilityContextResolver {

    private static final String TENANT_HEADER = "X-Tenant";
    private final ResourceStateSnapshotProvider resourceStateSnapshotProvider;

    public DefaultActionAvailabilityContextResolver() {
        this(new NoOpResourceStateSnapshotProvider());
    }

    public DefaultActionAvailabilityContextResolver(ResourceStateSnapshotProvider resourceStateSnapshotProvider) {
        this.resourceStateSnapshotProvider = resourceStateSnapshotProvider;
    }

    @Override
    public ActionAvailabilityContext resolve(String resourceKey, String resourcePath, Object resourceId) {
    ...
    private void extractAuthorities(Object source, Collection<String> sink) {
        ...
        try {
            ...
            // Principal sem authorities expostas; contexto segue neutro.
        }
    }
    ...
    private ResourceStateSnapshot resolveResourceState(String resourceKey, Object resourceId) {
        ...
        Optional<ResourceStateSnapshot> resolved = resourceStateSnapshotProvider.resolve(resourceKey, resourceId);

...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.codexrodrigues/praxis-metadata-starter?logo=apachemaven&color=blue&cacheSeconds=600&t=1.0.0-rc.7)](https://central.sonatype.com/artifact/io.github.codexrodrigues/praxis-metadata-starter)
...
- Para testar a build RC assim que publicada no Central, use `1.0.0-rc.7`.

...
- `CanonicalOpenApiGroupSnapshot` agora oferece captura exata e leituras públicas de request/response sobre a mesma cópia defensiva do grupo, mantendo mídia, dialeto OpenAPI, schemas e variantes 2xx. É uma observação pontual, sem prova de frescor/readiness ou anúncio de capability.
